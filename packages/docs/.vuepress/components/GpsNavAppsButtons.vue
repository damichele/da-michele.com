<template>
  <div class="gps-nav-apps-buttons">
    <p>
      <a
        href="https://maps.apple.com/?ll=48.786975,8.1936724&amp;address=Ristorante+da+Michele,Sinzheimer+Strasse+4,Baden-Baden,Germany&amp;z=19&amp;dirflg=d"
        target="_blank"
      ...
      >
        <svg
          ...
          original-source="https://simpleicons.org/icons/apple.svg"
        >
      ...
      >
        <svg
          ...
          height="16"
          xmlns="http://www.w3.org/2000/svg"
          original-source="https://simpleicons.org/icons/googlemaps.svg"
        >
      ...
      >
        <svg
          ...
          height="16"
          xmlns="http://www.w3.org/2000/svg"
          original-source="https://simpleicons.org/icons/here.svg"
        >
      ...
      >
        <svg
          ...
          height="16"
          xmlns="http://www.w3.org/2000/svg"
          original-source="https://simpleicons.org/icons/waze.svg"
        >
          <title>Waze</title>
